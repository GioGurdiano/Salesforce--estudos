...
gulp.task("lint:js-server", () => {
    ...
    const esLintSrc = [
        "cartridges/app_training/cartridge/{controllers,models,scripts}/**/*.js"
    ];
...
gulp.task("lint:js-client", () => {
    const esLint = require("gulp-eslint");
    const esLintSrc = [
        "cartridges/app_training/cartridge/client/default/js/**/*.js"
    ];
...
gulp.task("lint:scss", () => {
    ...
    const styleLintSrc = [
        "cartridges/app_training/cartridge/client/default/scss/**/*.scss"
    ];
